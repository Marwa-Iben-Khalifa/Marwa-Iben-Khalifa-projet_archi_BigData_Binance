...
for coin in crypto_list:
    ...
    while start_date < end_date:
        # Increment one day
        def download_and_unzip(my_date, coin_name):
            ...
            try:
                wget.download(_url, f'{folder_name}/{file_name}')
                # Extract zip
                with zipfile.ZipFile(f'{folder_name}/{file_name}', 'r') as zip_ref:
        ...
        pool.apply_async(download_and_unzip, (start_date, coin, ))
